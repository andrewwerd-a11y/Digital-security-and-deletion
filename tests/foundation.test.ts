...
describe("foundation artifacts", () => {
  it("exposes all repository families", () => {
    ...
    expect(Object.keys(repos)).toHaveLength(21);
  });

  it("contains wave a through wave k migrations", () => {
    ...
    const waveK = readFileSync("prisma/migrations/0010_wave_k_verification_reporting_residual_risk/migration.sql", "utf8");
    ...
    expect(waveK).toContain("CREATE TABLE \"ResidualRiskRecord\"");
  });
});
