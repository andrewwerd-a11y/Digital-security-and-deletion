...
export interface DiscoveryRunRepository {
  create(record: Omit<DiscoveryRunRecord, "id">): Promise<DiscoveryRunRecord>;
  update(id: string, patch: Partial<Omit<DiscoveryRunRecord, "id" | "workflowId">>): Promise<DiscoveryRunRecord>;
  getById(id: string): Promise<DiscoveryRunRecord | null>;
}

export interface DiscoveryFindingRepository {
  create(record: Omit<DiscoveryFindingRecord, "id" | "createdAt">): Promise<DiscoveryFindingRecord>;
  listByRun(discoveryRunId: string): Promise<DiscoveryFindingRecord[]>;
}
